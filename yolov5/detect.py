    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if (cupnumb > 2) and (density > 1):
                cv2.putText(im0,"Uncomfortable Environment!",(1400,50),fontFace=cv2.FONT_HERSHEY_SIMPLEX,fontScale=1.2,color=(0,255,255),thickness=3)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='E://CoffeeData/RecordFile/20211217/192.168.1.214_8000_1_158BB0CF903C41DABBD6A47CF1305427_/Stage1.mp4', help='file/dir/URL/glob, 0 for webcam') # default='rtsp://admin:HK88888888@192.168.1.214:554/11', help='file/dir/URL/glob, 0 for webcam'
